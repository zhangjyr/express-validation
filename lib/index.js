...
exports = module.exports = function (schema) {
  ...
  return function (req, res, next)  {
    ...
    // NOTE: mutates `errors`
    validate(errors, req.headers, schema.headers, 'headers', options.allowUnknownHeaders, options);
    validate(errors, req.body, schema.body, 'body', options.allowUnknownBody, options);
    validate(errors, req.query, schema.query, 'query', options.allowUnknownQuery, options);
    validate(errors, isPlainObject(req.params) ? req.params : {}, schema.params, 'params', options.allowUnknownParams, options);
    validate(errors, req.cookies, schema.cookies, 'cookies', options.allowUnknownCookies, options);
 ...
 */
function validate (errObj, request, schema, location, allowUnknown, options) {
  ...
  if (options && options.language) {
      joiOptions.language = options.language;
  }
